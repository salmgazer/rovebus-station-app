...
class TripListItem extends ListTile {


  TripListItem(Trip trip, BuildContext context) :
    super(
      title : Text(trip.arrivalStationName, style: TextStyle(fontSize: 20),),
      subtitle: Text('Time: ${trip.departureTime.hour}:${trip.departureTime.minute} am     Seats left: 5', style: TextStyle(color: Colors.brown[400], fontSize: 15)),
      onTap: () {
